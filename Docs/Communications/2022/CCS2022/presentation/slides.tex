...
\begin{columns}
	...
	\begin{column}{0.4\textwidth}
		...
		$\rightarrow$ Work on \textit{Didot-Bottin}, covering most of 19th century OTHER sources
		...
		$\rightarrow$ Named Entity Recognition to extract names, adresses, professions
...
$\rightarrow$ Data covering 1857-1908: XXX entries, X\% with coordinates.
...
$\rightarrow$ Stems with more than 100 occurrences (XXXX) coded for broad activities (food, craftsmanship, art and literature, health, law and governance, service, teaching)

\bigskip

$\rightarrow$ XXXX entries with coordinates and activities
...
\begin{center}
\hspace{-1cm}
	%\includegraphics[width=0.49\textwidth, trim={0 0 4.5cm 0}]{figures/density-1841.png}\hspace{0.1cm}
	%\includegraphics[width=0.49\textwidth, trim={0 0 4.5cm 0}]{figures/density-1844.png}
\end{center}
...
\[
\rho_{r,s}(\tau) = \rho \left[\Delta N_{a,r} (t), \Delta N_{a,s} (t - \tau) \right]
\]
...
%\includegraphics[height=0.9\textheight]{figures/laggedcorrs-12.png}
...
$\rightarrow$ Endogenous spatial neighbourhoods to estimate correlations, using a GWR-like approach \cite{brunsdon1998geographically}. (// original method) + SENSITIVITY ANALYSIS 

\medskip

$\rightarrow$ Benchmark of methods to measure co-evolution (instrumental variables, causal machine learning).
