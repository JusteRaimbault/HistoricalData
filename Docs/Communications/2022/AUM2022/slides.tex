...
\begin{columns}
	...
	\begin{column}{0.4\textwidth}
		...
		$\rightarrow$ Work on \textit{Didot-Bottin}, covering most of 19th century
...
$\rightarrow$ Data sample covering 1841-1844: 415,976 entries, 33\% with coordinates.
...
$\rightarrow$ Stems with more than 100 occurrences (578) coded for broad activities (food, craftsmanship, art and literature, health, law and governance, service, teaching)

\bigskip

$\rightarrow$ 36,072 entries with coordinates and activities
...
$\rightarrow$ Endogenous spatial neighbourhoods to estimate correlations, using a GWR-like approach \cite{brunsdon1998geographically}.
